...
const ManageCodingRound = () => {
  ...
  return (
    <Layout style={{ minHeight: "100vh" }} className="custom-layout">
      <Sider
        collapsible
        collapsed={collapsed}
      ...
      <Layout className="custom-site-layout">
                    ...
                    <div>
                      ...
                      <ul>
                        {question.testcases.map((testcase, index) => (
                          <li key={index} className="custom-test-case">
                            <p>
            ...
            >
              <Form form={form} layout="vertical" name="questionForm">
                ...
                <Form.Item
                  ...
                  name="example"
                  rules={[
                    { required: true, message: "Please enter an example" },
                  ]}
                >
                  <TextArea rows={2} />
                </Form.Item>
                ...
                {testCases.map((testCase, index) => (
                  <div key={index} className="custom-test-case-item">
                    <Form.Item
