...
const CodeEditor = () => {
  ...
  return (
    <Layout className="layout" style={{ background: '#fff' }}>
        ...
        <Layout style={{ padding: '0 24px 24px' }}>
          ...
          >
            <Card title="Code Editor">
              <Row gutter={[16, 16]}>
                <Col span={24}>
                  <Select defaultValue="javascript" style={{ width: 120, marginRight: 10 }} onChange={handleLanguageChange}>
                ...
                <Col span={24}>
                  <Button type="primary" onClick={handleRunCode} style={{ marginRight: '10px' }}>
                    Run Code
                  </Button>
      ...
      <Footer style={{ textAlign: 'center' }}>Code Editor ©2024 Created by Your Name</Footer>
    </Layout>
  );
};
